  ...
  return (
    <div className="relative z-10">
      ...
      >
        ...
        {/* Actions group - flexible for different screens */}
        <div className="flex items-center gap-2 sm:gap-4">
          {/* Theme and Language selectors - hidden on very small screens, shown in mobile menu */}
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute inset-x-0 top-full mt-2 p-4 bg-[#0a0a0f]/95 backdrop-blur-xl rounded-lg border border-white/5 shadow-xl z-20 flex flex-col gap-4 animate-fadeIn">
          ...
          {/* Mobile settings */}
          <div className="mt-2">
            <h3 className="text-xs uppercase text-gray-500 font-medium mb-1">Settings</h3>
            <div className="grid grid-cols-2 gap-2">
              <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-800">
                <h4 className="text-xs text-gray-400 mb-2">Theme</h4>
                <ThemeSelector />
              </div>
              <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-800">
